...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(370, 272)
        Dialog.setMouseTracking(False)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("UI\\shrimp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Dialog.setWindowIcon(icon)
        Dialog.setAutoFillBackground(False)
        self.gridLayoutWidget = QtWidgets.QWidget(Dialog)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 10, 351, 251))
        ...
        self.gridLayout.addWidget(self.SP_in, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.status_out, 3, 2, 1, 2)
